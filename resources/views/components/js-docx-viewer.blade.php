...
<body>
            ...
            <div class="document-viewer">
                ...
                <div id="error-content" style="display: none;">
                    <div class="error-message">
                        ...
                        <p>We encountered an error while trying to load your DOCX file. This could be due to:</p>
                        <ul>
    ...
    <script src="https://unpkg.com/docx-preview@2.0.0/build/index.js"></script>
    ...
    <script>
        ...
        async function loadDocument() {
            ...
            try {
                ...
                // Parse the DOCX
                const result = await docx.renderAsync(arrayBuffer, content, null, options);
