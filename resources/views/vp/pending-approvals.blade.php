        ...
        <div class="bg-gradient-to-r from-green-600 to-green-700 border border-yellow-600 overflow-hidden shadow-sm sm:rounded-xl mb-6">
            <div class="p-6 border-b border-yellow-600">
                <h3 class="text-lg font-semibold text-white flex items-center">
                    ...
                    Activities Pending VP Approval
                </h3>
                <p class="text-sm text-yellow-200 mt-1">Activities that have been endorsed by the Director and are awaiting final VP approval</p>
            </div>
        </div>
                ...
                <table class="min-w-full divide-y divide-green-300">
                    <thead class="bg-green-200">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-green-800 uppercase tracking-wider">Director Endorsed</th>
                    ...
                    <tbody class="bg-white divide-y divide-green-200">
                        @forelse($activities as $activity)
                            <tr class="hover:bg-green-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ $activity->director_endorsed_at ? $activity->director_endorsed_at->format('M d, Y') : 'N/A' }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('vp.show-activity', $activity) }}" class="text-blue-600 hover:text-blue-900">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <button onclick="openApproveModal({{ $activity->id }}, '{{ $activity->title }}')" class="text-green-600 hover:text-green-900">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                                    ...
                                    <p class="text-gray-500">No activities pending VP approval.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
