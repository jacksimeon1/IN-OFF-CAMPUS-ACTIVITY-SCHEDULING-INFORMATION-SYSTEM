...
@section('page-title', 'Director Profile Settings')
...
<div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-6">
                        ...
                        <p class="text-yellow-200 text-sm mt-1">Director</p>
                        <p class="text-yellow-200 text-xs mt-1">Institutional Oversight</p>
                    </div>
                </div>
                <div class="flex-shrink-0">
                    <div class="text-right">
                        <div class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-yellow-600 bg-opacity-90 text-white">
    ...
    <div class="bg-gradient-to-br from-green-50 to-yellow-50 border border-green-300 overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <form method="post" action="{{ route('director.profile.update') }}" class="p-6 space-y-6">
            @csrf
            @method('patch')
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <form method="post" action="{{ route('director.password.update') }}" class="p-6 space-y-6">
            @csrf
            @method('put')
