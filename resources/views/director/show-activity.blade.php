    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('director.pending-endorsements') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-lg font-semibold text-sm text-white uppercase tracking-widest hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200">
                    <i class="fas fa-arrow-left mr-2"></i> Back to Endorsements
                </a>
                @if($activity->workflow_status === 'reviewed_by_psg')
                    <button onclick="openEndorseModal({{ $activity->id }}, '{{ $activity->title }}')" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-lg font-semibold text-sm text-white uppercase tracking-widest hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-200">
                        <i class="fas fa-stamp mr-2"></i> Endorse
                    </button>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                        ...
                        @elseif($activity->workflow_status === 'reviewed_by_psg') bg-blue-100 text-blue-800
                            ...
                            <div class="relative">
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                        ...
                                        <div class="text-right text-sm whitespace-nowrap text-gray-500">
                                            {{ $activity->director_endorsed_at ? $activity->director_endorsed_at->format('M d, Y g:i A') : 'Pending' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-green-100">
                <i class="fas fa-stamp text-green-600 text-xl"></i>
            </div>
            ...
            <div class="mt-2 px-7 py-3">
                ...
                <form id="endorseForm" method="POST" class="mt-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="notes" id="endorseNotes" rows="3" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" placeholder="Add any notes for this endorsement..."></textarea>
                    </div>
