...
<div class="space-y-6">
                ...
                <div class="card-content">
                    <div class="flex items-center justify-between">
                        <div class="stat-info">
                            ...
                            <h3 class="stat-title">Pending Endorsements</h3>
                            <p class="stat-number">{{ $pendingEndorsements }}</p>
                            <p class="stat-subtitle">Awaiting endorsement</p>
                        </div>
                ...
                <div class="card-content">
                    <div class="flex items-center justify-between">
                        <div class="stat-info">
                            ...
                            <h3 class="stat-title">Endorsed by Me</h3>
                            <p class="stat-number">{{ $endorsedActivities }}</p>
                            <p class="stat-subtitle">Director endorsed</p>
                        </div>
                        <div class="stat-visual">
                            <div class="pulse-ring"></div>
                            <div class="pulse-ring-2"></div>
    ...
    <!-- Activities Awaiting Endorsement and Recent Institutional Activities -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <!-- Activities Awaiting Endorsement -->
                ...
                @if($activitiesAwaitingEndorsement->count() > 0)
                        ...
                        @foreach($activitiesAwaitingEndorsement as $activity)
                            <div class="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-green-100 rounded-lg border border-green-200 hover:from-green-100 hover:to-green-200 transition-all duration-200">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="{{ route('director.show-activity', $activity) }}" class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-600 text-white hover:bg-green-700 shadow-sm hover:shadow-md transition-all duration-200">
                    ...
                    @if($activitiesAwaitingEndorsement->count() >= 10)
                        <div class="mt-4 text-center">
                            <a href="{{ route('director.pending-endorsements') }}" class="text-green-600 hover:text-green-700 text-sm font-medium">View all pending endorsements</a>
                        </div>
                    @endif
                @else
                    <div class="text-center py-8">
                        <i class="fas fa-check-circle text-green-500 text-3xl mb-3"></i>
                        <p class="text-gray-600">No activities pending endorsement</p>
        ...
        <div class="content-card">
            ...
            <div class="content-card-body">
                @if($recentInstitutionalActivities->count() > 0)
                    ...
                    <div class="mt-4 text-center">
                        <a href="{{ route('director.dashboard') }}" class="text-green-600 hover:text-green-700 text-sm font-medium">View all activities</a>
                    </div>
                @else
                    <div class="text-center py-8">
