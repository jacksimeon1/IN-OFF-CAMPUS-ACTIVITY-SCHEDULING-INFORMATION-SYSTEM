    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <div class="nav-item">
                    <a href="{{ route('psg.dashboard') }}" class="nav-link {{ request()->routeIs('psg.dashboard') ? 'active' : '' }}">
                        <div class="nav-icon">
                            <i class="fas fa-users"></i>
                        </div>
                        <span class="nav-text">PSG Adviser</span>
                ...
                <div class="nav-item">
                    <a href="{{ route('vp.dashboard') }}" class="nav-link {{ request()->routeIs('vp.dashboard') ? 'active' : '' }}">
                        <div class="nav-icon">
                            <i class="fas fa-crown"></i>
                        </div>
                        <span class="nav-text">VP Academics</span>
                ...
                <div class="nav-item">
                    <a href="{{ route('osa.dashboard') }}" class="nav-link {{ request()->routeIs('osa.dashboard') ? 'active' : '' }}">
                        ...
                        <span class="nav-text">OSA Staff</span>
