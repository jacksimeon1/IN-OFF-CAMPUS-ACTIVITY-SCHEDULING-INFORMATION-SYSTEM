...
<div class="space-y-6">
                ...
                <div class="card-content">
                    <div class="flex items-center justify-between">
                        <div class="stat-info">
                            ...
                            <p class="stat-number">{{ $approvedByMe }}</p>
                            <p class="stat-subtitle">Activities reviewed</p>
                        </div>
                        <div class="stat-visual">
                            <div class="pulse-ring"></div>
                            <div class="pulse-ring-2"></div>
                ...
                <div class="card-content">
                    <div class="flex items-center justify-between">
                        <div class="stat-info">
                            ...
                            <h3 class="stat-title">Department Activities</h3>
                            <p class="stat-number">{{ $totalStudentActivities }}</p>
                            <p class="stat-subtitle">Total submissions</p>
                        </div>
                        <div class="stat-visual">
                            <div class="pulse-ring"></div>
                            <div class="pulse-ring-2"></div>
    ...
    <!-- Activities Awaiting Approval and Recent Department Activities -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="content-card">
            ...
            <div class="content-card-body">
                @if($activitiesAwaitingApproval->count() > 0)
                    <div class="space-y-4">
                        @foreach($activitiesAwaitingApproval as $activity)
                            <div class="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-green-100 rounded-lg border border-green-200 hover:from-green-100 hover:to-green-200 transition-all duration-200">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="{{ route('adviser.show-activity', $activity) }}" class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-600 text-white hover:bg-green-700 shadow-sm hover:shadow-md transition-all duration-200">
                    ...
                    @if($activitiesAwaitingApproval->count() >= 10)
                        <div class="mt-4 text-center">
                            <a href="{{ route('adviser.pending-approvals') }}" class="text-green-600 hover:text-green-700 text-sm font-medium">View all pending approvals</a>
                        </div>
                    @endif
                @else
                    <div class="text-center py-8">
                        <i class="fas fa-check-circle text-green-500 text-3xl mb-3"></i>
                        <p class="text-gray-600">No activities pending approval</p>
        ...
        <div class="content-card">
            ...
            <div class="content-card-body">
                @if($recentDepartmentActivities->count() > 0)
                    ...
                    <div class="mt-4 text-center">
                        <a href="{{ route('adviser.pending-approvals') }}" class="text-green-600 hover:text-green-700 text-sm font-medium">View all activities</a>
                    </div>
                @else
                    <div class="text-center py-8">
