...
@section('title', 'PSG Profile')
@section('page-title', 'PSG Council Profile Settings')
...
<div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-6">
                        ...
                        <p class="text-yellow-200 text-sm mt-1">PSG Council Adviser</p>
    ...
    <div class="bg-gradient-to-br from-green-50 to-yellow-50 border border-green-300 overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <form method="post" action="{{ route('psg.profile.update') }}" class="p-6 space-y-6">
            @csrf
            @method('patch')
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <form method="post" action="{{ route('psg.password.update') }}" class="p-6 space-y-6">
            @csrf
            @method('put')
