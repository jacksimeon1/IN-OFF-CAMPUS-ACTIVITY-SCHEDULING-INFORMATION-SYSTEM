...
@section('title', 'PSG Dashboard')
@section('page-title', 'PSG Council Dashboard')
...
<div class="space-y-6">
                ...
                <div class="card-content">
                    <div class="flex items-center justify-between">
                        <div class="stat-info">
                            ...
                            <p class="stat-number">{{ $pendingPsgReviews }}</p>
                            <p class="stat-subtitle">Awaiting PSG review</p>
                        </div>
                ...
                <div class="card-content">
                    <div class="flex items-center justify-between">
                        <div class="stat-info">
                            ...
                            <h3 class="stat-title">Student Activities</h3>
                ...
                <div class="card-content">
                    <div class="flex items-center justify-between">
                        <div class="stat-info">
                            ...
                            <h3 class="stat-title">Reviewed by Me</h3>
                            <p class="stat-number">{{ $reviewedActivities }}</p>
                            <p class="stat-subtitle">PSG reviewed</p>
                        </div>
                        <div class="stat-visual">
                            <div class="pulse-ring"></div>
                            <div class="pulse-ring-2"></div>
    ...
    <!-- Activities Awaiting PSG Review and Recent Student Activities -->
                ...
                @if($activitiesAwaitingPsgReview->count() > 0)
                        ...
                        @foreach($activitiesAwaitingPsgReview as $activity)
                            <div class="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-green-100 rounded-lg border border-green-200 hover:from-green-100 hover:to-green-200 transition-all duration-200">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="{{ route('psg.show-activity', $activity) }}" class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-600 text-white hover:bg-green-700 shadow-sm hover:shadow-md transition-all duration-200">
                    ...
                    @if($activitiesAwaitingPsgReview->count() >= 10)
                        <div class="mt-4 text-center">
                            <a href="{{ route('psg.pending-reviews') }}" class="text-green-600 hover:text-green-700 text-sm font-medium">View all pending reviews</a>
                        </div>
                    @endif
                @else
                    <div class="text-center py-8">
                        <i class="fas fa-check-circle text-green-500 text-3xl mb-3"></i>
                        <p class="text-gray-600">No activities pending PSG review</p>
