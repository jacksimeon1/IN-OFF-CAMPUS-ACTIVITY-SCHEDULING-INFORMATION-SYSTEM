        ...
        <div class="bg-gradient-to-r from-green-600 to-green-700 border border-yellow-600 overflow-hidden shadow-sm sm:rounded-xl mb-6">
            <div class="p-6 border-b border-yellow-600">
                <h3 class="text-lg font-semibold text-white flex items-center">
                    ...
                    Activities Pending PSG Review
                </h3>
                <p class="text-sm text-yellow-200 mt-1">Activities that have been noted by the Dean and are awaiting PSG review</p>
            </div>
        </div>
                ...
                <table class="min-w-full divide-y divide-green-300">
                    <thead class="bg-green-200">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-green-800 uppercase tracking-wider">Dean Noted</th>
                    ...
                    <tbody class="bg-white divide-y divide-green-200">
                        @forelse($activities as $activity)
                            <tr class="hover:bg-green-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ $activity->dean_noted_at ? $activity->dean_noted_at->format('M d, Y') : 'N/A' }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('psg.show-activity', $activity) }}" class="text-blue-600 hover:text-blue-900">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <button onclick="openReviewModal({{ $activity->id }}, '{{ $activity->title }}')" class="text-green-600 hover:text-green-900">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                                    ...
                                    <p class="text-gray-500">No activities pending PSG review.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
...
<div id="reviewModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900 mt-2">Review Activity</h3>
