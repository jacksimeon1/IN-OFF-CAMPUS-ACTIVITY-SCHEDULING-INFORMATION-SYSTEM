    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('psg.pending-reviews') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-lg font-semibold text-sm text-white uppercase tracking-widest hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200">
                    <i class="fas fa-arrow-left mr-2"></i> Back to Reviews
                </a>
                @if($activity->workflow_status === 'noted_by_dean')
                    <button onclick="openReviewModal({{ $activity->id }}, '{{ $activity->title }}')" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-lg font-semibold text-sm text-white uppercase tracking-widest hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-200">
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                        ...
                        @elseif($activity->workflow_status === 'noted_by_dean') bg-yellow-100 text-yellow-800
            ...
            <div class="p-6">
                <div class="flow-root">
                    <ul class="-mb-8">
                        ...
                        @endif
                        @if($activity->workflow_status === 'reviewed_by_psg')
                        <li>
                            <div class="relative">
                                <div class="relative flex space-x-3">
                                    <div>
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                        ...
                                        <div class="text-right text-sm whitespace-nowrap text-gray-500">
                                            {{ $activity->psg_reviewed_at ? $activity->psg_reviewed_at->format('M d, Y g:i A') : 'Pending' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div id="reviewModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900 mt-2">Approve Activity</h3>
            <div class="mt-2 px-7 py-3">
                <p class="text-sm text-gray-500" id="reviewActivityTitle">
                    Are you sure you want to approve this activity for PSG review?
                </p>
...
function openReviewModal(activityId, activityTitle) {
    document.getElementById('reviewActivityTitle').textContent = `Approve "${activityTitle}" for PSG review?`;
    document.getElementById('reviewForm').action = `/psg/activities/${activityId}/review`;
...
function openRejectModal(activityId, activityTitle) {
    ...
    document.getElementById('rejectForm').action = `/psg/activities/${activityId}/review`;
